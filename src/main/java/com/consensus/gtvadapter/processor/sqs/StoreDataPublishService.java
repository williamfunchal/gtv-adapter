...
@Service
public class StoreDataPublishService extends CCSIAbstractQueuePublishService {

    private CCSIQueueProperties queueProperties;

    public StoreDataPublishService(final AmazonSQS amazonSQS, final QueueProperties queueProperties) {
        super(amazonSQS);
